...
class Spoty:
    ...
    def create_mat(self):
        try:
            ...
            if self.track[0] == None:
                title, artist = "not Conected", " "
            else:
                artist, title = self.track[0:2]
            ...
            # genereate image
            img = img_treatment(
                self.track[2], "resource/Spotify_NConnected.jpg", "link"
            )
            img.resize(32, 32)
    ...
    def puting_data(self, main_mat, cf):
        try:
            ...
            try:
                main_mat[5:10, 33 : 33 + 30, :] = self.text_title[cf]
            except IndexError:
                pass

            try:
                main_mat[13:18, 33 : 33 + 30, :] = self.text_artist[cf]
            except IndexError:
                pass
            ...
            print("Error in Spotify app (puting data): ", e)
        return main_mat
